...
{ 
    public partial class Client : Form
    {
        ...
        {
            int inst = CAdapter.Insert(txtname.Text, txtsurname.Text, Convert.ToDouble(txtmobile.Text), txtadd.Text, txtcity.Text);
        ...
        private void txtame_TextChanged(object sender, EventArgs e)
        {
